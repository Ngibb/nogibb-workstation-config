...
aptitude install libfdisk1
aptitude install gcc
aptitude install gdb
aptitude install cgdb
...
aptitude -f install google-chrome-stable_current_amd64.deb
