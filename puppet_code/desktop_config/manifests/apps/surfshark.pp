...
class desktop_config::apps::surfshark {
  ...
  exec {"install_surfshark_repo":
    command => "wget -q 'https://ocean.surfshark.com/debian/pool/main/s/surfshark-release/surfshark-release_1.0.0-1.1_amd64.deb' -O /tmp/${source_package}.deb && dpkg -i /tmp/${source_package}.deb",
